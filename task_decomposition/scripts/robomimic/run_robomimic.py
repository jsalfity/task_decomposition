...
def playback_dataset(args):
    save_frames = args.video_path is not None
    assert not (args.render and save_frames)  # either on-screen or video but not both
    ...
    env = EnvUtils.create_env_from_metadata(
        env_meta=env_meta, render=args.render, render_offscreen=save_frames
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--filename", type=str, default="toolhang")
